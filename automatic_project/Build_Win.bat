@echo off
:: Unity编辑器路径
set UNITY_PATH="D:\UnityEditor\6000.0.19f1\Editor\Unity.exe"
...
:: 设置输出路径
set LOCATION_PATH_NAME=.\Build\Windows2\newGame.exe
...
%UNITY_PATH% -batchmode -quit -projectPath %PROJECT_PATH% -executeMethod %EXECUTE_METHOD% -logFile %LOG_PATH% -buildTarget %BUILD_TARGET% -locationPathName %LOCATION_PATH_NAME% -scenes %SCENES% -buildOptions %BUILD_OPTIONS%
